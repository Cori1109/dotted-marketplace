...
function NFTTokenIds({ inputValue, setInputValue }) {
  ...
  const fetchFunction = "fetchMarketItems";
  ...
  async function fetchMarketItem() {
    console.log("fetchMarketItem called");
    setLoading(true);
    const ops = {
      contractAddress: marketAddress,
    ...
    console.log("fetchreq", ops);
    const isfetch = await contractProcessor.fetch({ params: ops });
    const fetchData = JSON.stringify(contractProcessor.data);
    console.log("fetchdata", isfetch, fetchData);
  }
              ...
              <Card
                ...
                actions={[
                  ...
                  <Tooltip title="Buy NFT">
                    <ShoppingCartOutlined onClick={() => fetchMarketItem()} />
